jQuery(document).ready(function($) {
	...
	var shareBox = {
		...
		linkedin: function(data) {
			var inAPI = "https://www.linkedin.com/shareArticle",
				title = encodeURIComponent(data.pageTitle),
				url = encodeURIComponent(data.pageUrl),
				desc = encodeURIComponent(data.pageDesc),
				source = encodeURIComponent("Jobplanet Indonesia");

			window.open(inAPI + "?mini=true&title=" + title + "&url=" + url + "&summary=" + desc + "&source=" + source,
				shareBox.windowOptions, "width=550,height=320"
			);
		},
		gplus: function(data) {
